...
POLICY: dict[str, dict[str, list[str]]] = {
    "ADMIN": {
        ...
        "CERRADO": ["EDITAR_DATOS", "REGISTRAR_PAGO", "CERRAR", "CANCELAR", "CAMBIAR_GESTOR", "CAMBIAR_MEDICO"],
        "CANCELADO": ["EDITAR_DATOS", "REGISTRAR_PAGO", "CANCELAR", "CAMBIAR_GESTOR", "CAMBIAR_MEDICO"],
    },
    "OPERADOR": {
        "REGISTRADO": ["EDITAR_DATOS", "ASIGNAR_GESTOR", "CANCELAR", "CAMBIAR_GESTOR", "CAMBIAR_MEDICO", "REGISTRAR_PAGO"],
